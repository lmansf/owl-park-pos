...
Managers SHALL be able to void an unpaid order and refund a paid order (full refund only):
status change, tickets → void, session sold counts decremented, negative payment row, audit
entry. Refunded tickets scan as denied thereafter.
